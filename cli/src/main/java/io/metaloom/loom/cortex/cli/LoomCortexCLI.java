...
public class LoomCortexCLI implements Runnable {

	private static LoomCortexCLI instance = new LoomCortexCLI();
	...
	public static int execute(String... args) {
		CommandLine cmd = new CommandLine(LoomCortexCLI.instance());
	...
	public static LoomCortexCLI instance() {
		return instance;
	}
}
